  ...
  handleScan(data) {
    ...
    if (value == 0 || value == 1 || value == 2) {
      if (value != this.state.qrCode) {
        ...
        if (value == 1) {
          this.setState({ boughtItem: 'LUSH makeup' })
        }
        if (value == 2) {
          this.setState({ boughtItem: 'TOMS Shoes' })
        }
        this.purchase(value)
      }
    ...
    return (
      <div className="main-container">
        ...
        <ul ref="numbers">
          ...
          <li id="1">TOMS Shoes</li>
          <li id="2">LUSH makeup</li>
        </ul>
        ...
        <div id="qr-reader">
          ...
          <img id="logo" src={`/img/${this.state.boughtItem}.jpg`} />
        </div>
